...
namespace TwitchChatOverlay
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            Bot TwitchBot = new Bot();
            TwitchBot.Connect();
            TwitchBot.OnMessageReceivedEvent += TwitchBot_OnMessageReceived;
        }

        private void TwitchBot_OnMessageReceived(object sender , OnBotMessageReceivedArgs e) => messagesBox.Items.Add(e.ToString());
